...
from core.crypto.sum_random import sum_random, calculate_validators_indexes
from core.crypto.secret import decode_random
from core.crypto.keys import Keys
from core.crypto.entropy import Entropy
...
from core.chain.params import Round, ROUND_DURATION
...
class Epoch:
    ...
    def get_current_time_frame_block_number(self):
    ...
    def is_current_timeframe_block_present(self):
        ...
        current_block_number = self.get_current_time_frame_block_number()
