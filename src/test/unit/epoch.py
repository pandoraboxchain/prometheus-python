...
from core.chain.epoch import Epoch, RoundIter, BLOCK_TIME
from core.chain.params import Round
from core.chain.block_factory import BlockFactory

from core.transaction.secret_sharing_transactions import PublicKeyTransaction, PrivateKeyTransaction, SplitRandomTransaction
from core.transaction.commit_transactions import CommitRandomTransaction, RevealRandomTransaction
from core.crypto.sum_random import sum_random
from core.crypto.private import Private
from core.crypto.secret import split_secret, encode_splits, decode_random
from core.crypto.keys import Keys
from core.chain.params import ROUND_DURATION
from test.unit.test_chain_generator import TestChainGenerator
...
class TestEpoch(unittest.TestCase):
    ...
    def test_commit_reveal(self):
        ...
        prev_hash = TestChainGenerator.fill_with_dummies(dag, dag.genesis_block().get_hash(),
        ...
        for i in Epoch.get_round_range(1, Round.COMMIT):
            ...
            self.assertEqual(decrypted_bytes,
                             random_bytes)  # TODO check if encryption decryption can work million times in a row
